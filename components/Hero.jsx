        ...
        <>
            <Jumbotron className={styles.hero}>
                <Row className={styles.heroRow}>
                    <Col xs={12} md={4} className={[styles.heroColumn, styles.hero__column__quote]}>
                        <p>“El secreto para salir adelante es empezar.”</p>
                    </Col>
                    <Col xs={12} md={6} className={[styles.heroColumn, styles.hero__column__image, styles.hero__column__image__text]}>
                        {
                            <p>{quote}</p>
                        }
                    </Col>
